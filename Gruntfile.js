        ...
        concat: {
           dist: {
               ...
               src: [
                   ...
                   "./src/js/ie8-fix.js",
                   "./src/js/defaults.js",
                   "./src/js/szn-backend-transport.js",
                   ...
                   "./src/js/szn-login-license-form-window-directive.js",
                   "./src/js/szn-register-form-window-directive.js",
                   "./src/js/szn-register-verify-form-window-directive.js",
                   "./src/js/szn-register-done-form-window-directive.js",
                   "./src/js/szn-login-init-directive.js",
